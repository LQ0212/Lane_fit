...
def grid_map_callback(msg):
    ...
    if temp_filtered_points:
        ...
        while current_angle < angles.min() + 3.5 * INTERVAL:
    ...
    #     # 使用互斥锁更新全局变量
        with lock:
            ...
            target_point = temp_target_point
            # curve_params = popt
...
def plot_data(event):
    global center_points, filtered_points, filtered_heights, centers, world_point, body_x, body_y, target_point
